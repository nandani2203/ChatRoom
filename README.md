...
2. **New → Web Service** → connect ChatRoom repo
3. Configure:
...
4. Deploy and copy your URL — e.g. `https://chatroom-backend-xxxx.onrender.com`
...
Value: https://chatroom-backend-xxxx.onrender.com
```
...
```bash
git add .
git commit -m "feat: full stack chat with rooms and REST APIs"
git push origin main
```

GitHub Actions builds and deploys automatically (~2 min).
Live at: `https://nandani2203.github.io/ChatRoom/`
